...
fn bindgen() {
  ...
  println!("cargo:rerun-if-changed=bgfx/include/bgfx/c99/bgfx.h");
  println!("cargo:rerun-if-changed=bgfx/include/bgfx/c99/platform.h");
  println!("cargo:rerun-if-changed={}", out_str);
}